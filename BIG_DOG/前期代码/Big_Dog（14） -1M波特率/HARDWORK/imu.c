...
//     Left_Front_Leg_Struct.Y_Add   =  0.5*LEFT_RIGHT_WIDTH*sin(IMU_Real_Data.Pitch*PI_180) + 0.5*FRONT_BACK_LENGTH*sin(IMU_Real_Data.Roll*PI_180 );
//     Right_Front_Leg_Struct.Y_Add  = -0.5*LEFT_RIGHT_WIDTH*sin(IMU_Real_Data.Pitch*PI_180) + 0.5*FRONT_BACK_LENGTH*sin(IMU_Real_Data.Roll*PI_180 );
//     Left_Back_Leg_Struct.Y_Add    =  0.5*LEFT_RIGHT_WIDTH*sin(IMU_Real_Data.Pitch*PI_180) - 0.5*FRONT_BACK_LENGTH*sin(IMU_Real_Data.Roll*PI_180 );
//     Right_Back_Leg_Struct.Y_Add   = -0.5*LEFT_RIGHT_WIDTH*sin(IMU_Real_Data.Pitch*PI_180) - 0.5*FRONT_BACK_LENGTH*sin(IMU_Real_Data.Roll*PI_180 );
