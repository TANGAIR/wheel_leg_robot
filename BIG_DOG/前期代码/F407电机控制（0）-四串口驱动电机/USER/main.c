...
/**************************************************************/
  ...
  while(1)
  {
			...
			if(mode==1)
		{
			  ...
			  USART52CAN_TX_Send_Cmd(CAN_DATA_CMD_ON,Contron_ID);
				delay_ms(delay_time);
				USART52CAN_TX_Send_Cmd(CAN_DATA_CMD_ON,Contron_ID_2);
//				delay_ms(delay_time);
...
//		  	USART22CAN_TX_Send_Cmd(CAN_DATA_CMD_ON,Contron_ID_4);
		...
		{
	  	  USART52CAN_TX_Send_Cmd(CAN_DATA_CMD_OFF,Contron_ID);
				delay_ms(delay_time);
			  USART52CAN_TX_Send_Cmd(CAN_DATA_CMD_OFF,Contron_ID_2);
//			  delay_ms(delay_time);
