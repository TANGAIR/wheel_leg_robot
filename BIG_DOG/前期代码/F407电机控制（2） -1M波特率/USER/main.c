...
int delay_time=16;  //以15ms为命令周期，就可以都收到 ，共计0.12s的八条腿指令周期
int led_num=0;
int main(void)//主函数
{
...
//			
//			  USART42CAN_TX_Send_Cmd(CAN_DATA_CMD_ON,Contron_ID);
//				delay_ms(delay_time);
//				USART42CAN_TX_Send_Cmd(CAN_DATA_CMD_ON,Contron_ID_2);
//				delay_ms(delay_time);
//			  USART22CAN_TX_Send_Cmd(CAN_DATA_CMD_ON,Contron_ID_3);
//			  delay_ms(delay_time);
//		  	USART22CAN_TX_Send_Cmd(CAN_DATA_CMD_ON,Contron_ID_4);
			
		}

		else
		{
//	  	  USART42CAN_TX_Send_Cmd(CAN_DATA_CMD_OFF,Contron_ID);
//				delay_ms(delay_time);
//			  USART42CAN_TX_Send_Cmd(CAN_DATA_CMD_OFF,Contron_ID_2);
//			  delay_ms(delay_time);
//				USART22CAN_TX_Send_Cmd(CAN_DATA_CMD_OFF,Contron_ID_3);
//			  delay_ms(delay_time);
//			  USART22CAN_TX_Send_Cmd(CAN_DATA_CMD_OFF,Contron_ID_4);
//			
		 ...
		 /*************LED闪烁****************************/
		 led_num++;
		 if(led_num >=10){led_num=0;LED2_TOGGLE;}
