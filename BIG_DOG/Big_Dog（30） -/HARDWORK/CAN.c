...
//关节电机命令
 ...
 char CAN_DATA_CMD_Change_ID[8] =   {0XFF,0XFF,0XFF,0XFF,0XFF,0XFF,0XF0,0X01}; //最后一位为ID号
	...
	if (CAN_GetITStatus(CAN1,CAN_IT_FMP0)!= RESET)
	{
		  CAN_Receive(CAN1,CAN_FIFO0,&CAN1_Rx_Message);
			...
			{	
				...
				Jiont_Motor_Unpack_CAN1.recieve.recieve_Current    = uint_to_float(((CAN1_Rx_Message.Data[4]&0x0f)<<8)|( CAN1_Rx_Message.Data[5]), -T_MAX, T_MAX, 12);
