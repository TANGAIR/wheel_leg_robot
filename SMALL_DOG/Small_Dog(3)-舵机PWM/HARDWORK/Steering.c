...
void Wheel_Steering_Init(void)
{
  ...
  RCC_APB1PeriphClockCmd( RCC_APB1Periph_TIM4,ENABLE);
	...
	TIM_TimeInitstruct.TIM_Period               =10000;    
	TIM_TimeInitstruct.TIM_Prescaler            =84-1;                 
 ...
 Left_Front_Speed(1250)  
 Left_Back_Speed(1250)    
 Right_Front_Speed(1250)   
 Right_Back_Speed(1250)   
...
void Joint_Steering_Init_2(void)
{
  ...
  RCC_APB2PeriphClockCmd( RCC_APB2Periph_TIM8,ENABLE);
	...
	TIM_TimeInitstruct.TIM_CounterMode          =TIM_CounterMode_Down;
	TIM_TimeInitstruct.TIM_Period               =2000;    
	TIM_TimeInitstruct.TIM_Prescaler            =1800-1;                 
